...
import ApplySuccessModal from "../../../utils/ApplySuccessModal"
...
const ProjectDetail = () => {
  ...
  return (
    <>
                ...
                <div className="mb-8 ml-10 justify-start">
                  <div className="flex flex-col w-48 ">
                    <Button
                      ...
                      variant="contained"
                      color="success"
                      className="buttons border-2 border-green-700 text-center mt-12"
                      style={{cursor:"pointer"}}
                      onClick={() => {
                        ProjectProposal(); // Call the ProjectProposal function
      ...
      <ApplySuccessModal isOpen={isModalOpen} handleClose={() => setModalOpen(false)}  />
    </>
